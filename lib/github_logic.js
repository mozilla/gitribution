  ...
  (function iterator (i) {
    ...
    async.parallel([
        function(callback){
          ...
          // Commit activity
          updateCommitActivity(r.githubOrgName, r.mozTeamName, r.githubRepoName, orgMembersList, since, function commitListUpdated (err, res) {
            callback(null);
          })
        ...
        function(callback){
          ...
          // Issues activity
          updateIssueActivity(r.githubOrgName, r.mozTeamName, r.githubRepoName, orgMembersList, since, function issueListUpdated (err, res) {
            callback(null);
          })
...
var updateCommitActivity = function (githubOrgName, mozTeamName, githubRepoName, orgMembersList, since, callback) {
...
var updateIssueActivity = function (githubOrgName, mozTeamName, githubRepoName, orgMembersList, since, callback) {
